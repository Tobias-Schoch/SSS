...
\lstinputlisting[style=PYTHON, frame=single, caption=Fouriertransformation anwenden und ein Amplitudenspektrum ausgeben  sowie Berechnung einiger Werte, captionpos=b, label=lst:APPENDIX_SOURCECODE_AREA1]{../task1.4.py}
\newpage
