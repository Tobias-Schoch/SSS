...
klein = ["klein100", "klein200", "klein300", "klein400", "klein500", "klein700", "klein850", "klein1000",
         "klein1200", "klein1500", "klein1700", "klein2000", "klein3000", "klein4000",
         "klein5000", "klein6000", "klein10000"]
...
gross = ["gross100", "gross200", "gross300", "gross400", "gross500", "gross700", "gross850", "gross1000",
         "gross1200", "gross1500", "gross1700", "gross2000", "gross3000", "gross4000",
         "gross5000", "gross6000", "gross10000"]
...
kleinphase = [228, 187, 113.2, 105.2, 70.6, 64.8, 34, 4.2, 1.8, 12.2, 12.1, 14.7, 8.88, 11.60, 5.92, 6.92, 3.67]
...
plt.plot(kleinamp, 'b', label='Kleiner Lautsprecher')
plt.plot(grossamp, 'y', label='Grosser Lautsprecher')
plt.title("Amplitude")
plt.ylabel('Amplitude in V')
plt.xlabel('Versuchnr.')
plt.grid(True)
plt.legend()
plt.savefig('data/img/amplitudeanzahl.png')
plt.show()

# Darstellung der Amplitudenmaxima für beide Lautsprecher im Verhältnis zur Frequenz
plt.plot(zeit, kleinamp, 'b', label='Kleiner Lautsprecher')
plt.plot(zeit, grossamp, 'y', label='Grosser Lautsprecher')
plt.title("Amplitude")
plt.ylabel('Amplitude in V')
plt.xlabel('Frequenz f in Hertz')
plt.grid(True)
plt.legend()
plt.savefig('data/img/amplitudefrequenz.png')
plt.show()

# Darstellung des Phasengangs für beide Lautsprecher im Verhältnis zur Dateinr.
plt.plot(kleinphase, 'b', label='Kleiner Lautsprecher')
plt.plot(grossphase, 'y', label='Grosser Lautsprecher')
plt.title("Phasengang")
plt.ylabel('Phasenverschiebung in µs')
plt.xlabel('Versuchnr.')
plt.grid(True)
plt.legend()
plt.savefig('data/img/phasenanzahl.png')
plt.show()

# Darstellung des Phasengangs für beide Lautsprecher im Verhältnis zur Frequenz
plt.plot(zeit, kleinphase, 'b', label='Kleiner Lautsprecher')
plt.plot(zeit, grossphase, 'y', label='Grosser Lautsprecher')
plt.title("Phasenverschiebung")
plt.ylabel('Phasenverschiebung in µs')
plt.xlabel('Frequenz f in Hz')
plt.grid(True)
plt.legend()
plt.savefig('data/img/phasenfrequenz.png')
plt.show()
...
plt.semilogx()
plt.legend()
plt.savefig('data/img/bodeamplitudeanzahl.png')
plt.show()
...
plt.semilogx()
plt.legend()
plt.savefig('data/img/bodeamplitudefrequenz.png')
plt.show()
...
plt.semilogx()
plt.legend()
plt.savefig('data/img/bodephasenanzahl.png')
plt.show()
...
plt.semilogx()
plt.legend()
plt.savefig('data/img/bodephasenfrequenz.png')
plt.show()