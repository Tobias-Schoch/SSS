...
for a in range(0, 17):
    ...
    # Die zwei Zeiten des kleinen Lautsprechers werden subtrahiert und multipliziert für eine mikrosekunden Darstellung
    # Zudem wird die berechnete Dauer gerundet
    timing1 = round((time1[1] - time1[0]) * 100000, 5)
    # Die zwei Zeiten des großen Lautsprechers werden subtrahiert und multipliziert für eine mikrosekunden Darstellung
    # Zudem wird die berechnete Dauer gerundet
